...
export default function Login() {
  ...
  const handleGoogleLogin = () => {
    // For now, show a message that Google OAuth needs setup
    setError(
      "Google OAuth requires configuration. Please use email/password signup instead."
    );
  };
    ...
    <div className="min-h-screen bg-[#050507] flex items-center justify-center px-4">
      <div className="w-full max-w-[400px]">
        ...
        <div className="bg-[#0A0A0F] border border-[rgba(255,255,255,0.08)] rounded-2xl p-8">
          ...
          {view === "login" && (
            <>
              <h2 className="font-['Archivo'] text-xl text-white text-center mb-1">
                Welcome Back
              </h2>
              ...
              >
                <svg width="18" height="18" viewBox="0 0 18 18">
                  ...
                  <path
                    fill="#34A853"
                    d="M9 18c2.43 0 4.467-.806 5.956-2.18l-2.908-2.259c-.806.54-1.837.86-3.048.86-2.344 0-4.328-1.58-5.036-3.711H.957v2.332A8.997 8.997 0 0 0 9 18z"
                  />
                  <path
                    fill="#FBBC05"
              ...
              <form onSubmit={handleLogin} className="space-y-4">
                ...
                {error && (
                  <p className="text-xs text-[#E85D4E] bg-[rgba(232,93,78,0.1)] border border-[rgba(232,93,78,0.2)] px-3 py-2 rounded-lg">
                    {error}
                  </p>
                )}
              ...
              <p className="mt-5 text-center text-sm text-[#6B7280]">
                ...
                <button
                  ...
                  className="text-[#E85D4E] hover:underline bg-transparent border-0 cursor-pointer"
                >
                  Sign up
                </button>
              </p>
          ...
          {view === "signup" && (
            <>
              ...
              <h2 className="font-['Archivo'] text-xl text-white mb-1">
                Create Account
              </h2>
            ...
            <>
              ...
              {devCode && (
                <div className="mb-4 bg-[rgba(74,222,128,0.1)] border border-[rgba(74,222,128,0.2)] rounded-lg p-3 text-center">
                  ...
                  <p className="text-2xl font-['JetBrains_Mono'] font-bold text-[#4ADE80] tracking-[0.2em]">
                    {devCode}
                  </p>
                  <p className="text-[10px] text-[#4ADE80] opacity-60 mt-1">
              ...
              <form onSubmit={handleVerify} className="space-y-4">
                ...
                {message && (
                  <p className="text-xs text-[#4ADE80] bg-[rgba(74,222,128,0.1)] border border-[rgba(74,222,128,0.2)] px-3 py-2 rounded-lg">
                    {message}
                  </p>
                )}
