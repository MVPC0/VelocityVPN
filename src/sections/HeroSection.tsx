...
const HeroSection: React.FC = () => {
  ...
  const stats = useMemo(
    () => [
      ...
      { value: 0, suffix: '', label: 'Security', color: 'text-[#A3B8D4]', isText: true, textValue: 'Cloudflare Protected' },
    ],
    []
  );
  ...
  return (
    <section id="hero" className="relative w-full min-h-[100dvh] overflow-hidden">
      ...
      <div className="relative z-10 flex flex-col items-center justify-center min-h-[100dvh] px-6">
        ...
        >
          Route-optimized servers in 18 global locations. WireGuard protocol, Cloudflare DDoS protection.
