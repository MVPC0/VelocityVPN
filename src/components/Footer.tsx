      ...
      <div className="max-w-[1200px] mx-auto px-6 lg:px-12 pt-16 pb-8">
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-10">
          ...
          <div className="col-span-2 md:col-span-1">
            <a
              href="#"
              className="font-['Archivo'] font-bold text-white text-xl tracking-tight inline-flex items-center"
              onClick={(e) => {
                e.preventDefault();
            ...
            <div className="flex gap-4 mt-6">
              {/* Social icons */}
              {['Discord', 'X', 'Reddit'].map((social) => (
                <span
                  key={social}
                  className="w-8 h-8 rounded-full border border-[rgba(255,255,255,0.08)] flex items-center justify-center text-[#9CA3AF] hover:text-white hover:border-[rgba(255,255,255,0.2)] transition-all cursor-pointer text-xs"
                >
                  {social === 'Discord' && (
          ...
          {footerColumns.map((col) => (
            <div key={col.title}>
              <h4 className="text-xs font-medium text-white uppercase tracking-[0.08em] mb-4">
                {col.title}
              </h4>
